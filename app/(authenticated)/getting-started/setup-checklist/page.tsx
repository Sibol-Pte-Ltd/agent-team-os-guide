...
const content = `<div class="breadcrumbs">
        ...
        <ul class="checklist">
          ...
          <li><strong>Verified trust system is enforcing.</strong> Run <code>trust-system.sh status</code> on the EC2 instance to confirm the trust system is active. You should see all four agents listed with their trust levels (Ember=L3, Scout=L2, Forge=L3, Architect=L2), a count of pending approvals, and recent trust decisions. If the command is not found, ensure <code>~/agents/shared/scripts/</code> is in your PATH or run it with the full path.</li>
