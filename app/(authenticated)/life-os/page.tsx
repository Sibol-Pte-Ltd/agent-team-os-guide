...
export const metadata: Metadata = {
  title: 'What is Life OS — Agent Team OS Guide',
}
...
const content = `<div class="breadcrumbs">
        ...
        <h1>What is Life OS</h1>

        <p>Life OS is the personal operating system layer at the heart of Agent Team OS. It is an organizational framework built on top of <a href="/life-os/logseq-tips">LogSeq</a>, a local-first knowledge management tool, and it serves as the single source of truth for everything in your life that you want to track, plan, and act on. Tasks, notes, goals, projects, routines, reference material, and reflections all live inside Life OS. It is where you think, and it is where your agents work.</p>

        <p>The agents in your team read from and write to Life OS constantly. When Ember prepares your morning report, it pulls priorities and calendar events from Life OS. When Scout completes a research task, it writes the results back into a Life OS page. When you capture a quick thought in your daily journal, it becomes visible to the agents and can inform their next actions. Life OS is the shared workspace that makes human-agent collaboration seamless — you and your agents are always looking at the same information.</p>
        ...
        <div class="callout note">
          ...
          <p>You do not need to build out the entire Life OS structure before you start using the system. Begin with the daily journal and let the structure grow organically. The agents will help you create project and area pages as they become relevant to your work.</p>
        </div>

        <div class="action-section">
          <h2>What You Do Next</h2>
          <ul>
            <li><a href="/life-os/daily-workflow">Learn the Daily Workflow</a> to see how Life OS fits into your day</li>
