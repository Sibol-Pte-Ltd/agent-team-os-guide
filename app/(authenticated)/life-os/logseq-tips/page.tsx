...
const content = `<div class="breadcrumbs">
        ...
        <p>LogSeq is the note-taking application that powers Life OS. If you are new to LogSeq, this page covers the essential concepts and shortcuts you need to use Life OS effectively. This is not a comprehensive LogSeq tutorial — it focuses on the features that matter most for your daily interaction with Agent Team OS.</p>
        ...
        <p>In Life OS, page links are how you connect daily journal entries to project pages, area pages, and other reference material. When you mention <code>[[My Side Project]]</code> in your journal, that entry automatically appears in the "Linked References" section at the bottom of the My Side Project page. The agents also use page links extensively when writing content into Life OS.</p>

        <h3>The Slash Command Menu</h3>

        <p>Typing <code>/</code> in any block opens the command menu, which gives you quick access to a wide range of actions. The most commonly used commands for Life OS include:</p>
